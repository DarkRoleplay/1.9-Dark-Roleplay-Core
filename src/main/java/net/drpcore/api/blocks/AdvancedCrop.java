...
public class AdvancedCrop extends AdvancedPlant implements net.minecraftforge.common.IPlantable{

    public static final PropertyInteger AGE = PropertyInteger.create("age", 0, 7);;
	
    private Block soil;
    
    public AdvancedCrop(int daysTillGrown){
    	super(daysTillGrown);
    }
    ...
    public net.minecraftforge.common.EnumPlantType getPlantType(net.minecraft.world.IBlockAccess world, BlockPos pos){
        return this == net.minecraft.init.Blocks.NETHER_WART ? net.minecraftforge.common.EnumPlantType.Nether : net.minecraftforge.common.EnumPlantType.Crop;
    }
