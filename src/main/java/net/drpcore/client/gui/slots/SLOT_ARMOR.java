...
public class SLOT_ARMOR extends Slot {
	...
	public boolean isItemValid(ItemStack itemstack) {
		...
		ItemArmor item = (itemstack == null ? null : itemstack.getItem() instanceof ItemArmor ? (ItemArmor) itemstack.getItem() : null);
		
		EntityEquipmentSlot type = item.getEquipmentSlot();
		
		return item != null && item.isValidArmor(itemstack, type, player) && type == armorType;
	}
