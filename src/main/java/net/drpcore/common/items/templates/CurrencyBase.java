...
public class CurrencyBase extends Item{
	...
	/**
	 * @param Value
	 * Wouldn't Recommend to use values bellow 1 as it can be interpret as 1 cent
	 * @param Replacements Coins that will be give the player when he trades but doesn't uses the full value
	 * The first should be the most valuable
	 */
