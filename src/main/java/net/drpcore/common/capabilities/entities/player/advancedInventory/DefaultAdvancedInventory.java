...
public class DefaultAdvancedInventory implements IPlayerAdvancedInventory{
	...
	@Override
	public NBTTagCompound saveNBTData() {return (NBTTagCompound) AdvancedInventoryStorage.inventoryStorage.writeNBT(AdvancedInventoryProvider.ADVANCED_INVENTORY, this, null);}

	@Override
	public void loadNBTData(NBTTagCompound compound) {AdvancedInventoryStorage.inventoryStorage.readNBT(AdvancedInventoryProvider.ADVANCED_INVENTORY, this, null, compound);}
