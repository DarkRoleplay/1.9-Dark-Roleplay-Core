...
public class FoodIngredient {
	...
	/**
	 * @param foodType --> The type of the ingredient, determites if the player can eat it or not.
	 * @param name --> The name that will be displayed in the lore of food and used in code.
	 * @param FeedAmount --> The amount of food this ingredient will add to a food.
	 * @param SaturationAmount --> The amount of saturation this ingredient will add to food. 
	 */
