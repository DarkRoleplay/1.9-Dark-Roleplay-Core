...
public class CraftingRecipe {
	 ...
	 * @param Category 
	 * The Category you will find the Recipe choose what you want.
	 * Not existing Categorys will be added
	 * @param output
	 * The Output ItemStack
	 * @param mainIngredients
	 * The List of Items that is necesary for the Recipe
	 * example: {new ItemStack(Items.apple,1), new ItemStack(Items.sugar,1);}
	 */
