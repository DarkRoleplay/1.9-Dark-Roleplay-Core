...
public class Blueprint {
	...
	protected Blueprint(short sizeX, short sizeY, short sizeZ, short palleteSize, IBlockState[] pallete, short[][][] structure, NBTTagCompound[] tileEntities, List<String> requiredMods){
		this.sizeX = sizeX;
		this.sizeY = sizeY;
		this.sizeZ = sizeZ;
	 ...
	 * @param pos The Position at which to check
			...
			for(short z = 0; z < this.getSizeZ(); z++){
				for(short x = 0; x < this.getSizeX(); x++){
					...
					if(state.getBlock() == Blocks.STRUCTURE_VOID)
						continue;
					if(!world.getBlockState(transformedBlockPos(x, y, z, mirror, rotation)).getBlock().isReplaceable(world, pos.add(x,y,z)))
						return false;
				}
			}
		}
	 ...
	 * @param pos The Position to build the structure
	 */
	 ...
	 * @param world The world to generate the structure
	 * @param pos The Position to build the structure
	 * @param rotation The Rotation with which the structure should be generated
	 */
	 ...
	 * @param world The world to generate the structure
	 * @param pos The Position to build the structure* 
	 * @param mirror The Mirroring with which the structure should be generated
	 */
	...
	/**
	 * The main method to generate a structure,
	 * rotation and mirror don't affect the pallete,
	 * it does just change the structure.
	 */
	protected void build(World world, BlockPos pos, IBlockState[] pallete, short[][][] structure, Rotation rotation, Mirror mirror){
	...
	public void destroy(World world, BlockPos pos, IBlockState[] pallete, short[][][] structure, Rotation rotation, Mirror mirror){
		int indexVoid = -1;
		for(short y = 0; y < structure.length; y ++){
			for(short z = 0; z < structure[0].length; z++){
				for(short x = 0; x < structure[0][0].length; x++){
