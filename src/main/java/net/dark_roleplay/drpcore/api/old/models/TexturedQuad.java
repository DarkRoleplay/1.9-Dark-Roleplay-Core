package net.dark_roleplay.drpcore.api.old.models;
...
public class TexturedQuad
{
    ...
    public TexturedQuad(PositionTextureVertex[] vertices, float textureWidth, float textureHeight){
        this(vertices);
        for(int i = 0; i < 4; i++){
            vertices[i] = vertices[i].setTexturePosition(vertices[i].texturePositionX / textureWidth, vertices[i].texturePositionY / textureHeight);
        }
    }
