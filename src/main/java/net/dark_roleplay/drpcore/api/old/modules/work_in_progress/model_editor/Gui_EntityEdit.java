...
//	List<Bone> bones = new ArrayList<Bone>();
	...
	public Gui_EntityEdit(){
		this.bones = Json_Bones.readBonesFromJson(new ResourceLocation(References.MODID, "entities/test/bones.json"));
		Json_Models.readModelFromJson(new ResourceLocation(References.MODID, "entities/test/model.json"), this.bones);
