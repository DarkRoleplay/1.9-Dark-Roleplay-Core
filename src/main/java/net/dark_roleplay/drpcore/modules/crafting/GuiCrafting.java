...
import net.dark_roleplay.drpcore.modules.gui.HorizontalPanel;
...
public class GuiCrafting extends DRPGuiScreen{
	...
	public static final ResourceLocation BG = new ResourceLocation(DRPCoreReferences.MODID, "textures/guis/modular_gui/crafting_gui.png");
