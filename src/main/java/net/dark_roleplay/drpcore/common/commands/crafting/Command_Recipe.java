        	...
        	switch(args[0]){
        		...
        		case "progress":
        			if(cap.isUnlocked(recipe)){
            			...
            			player.addChatMessage(new TextComponentString("Progress mode requires an amount value! (0-100)"));
        			}
        		...
        		case "list":
        			...
        			if(locked.size() > 0){
	        			player.addChatMessage(new TextComponentString("Locked Recipes:"));
	        			for(String str : locked){
	        				combinedRecipes = combinedRecipes + "," + str;
	        				currentRecipe ++;
	        				if(currentRecipe == 5){
	        					player.addChatMessage(new TextComponentString(combinedRecipes));
	        					combinedRecipes = "";
	        					currentRecipe = 0;
	        				}
	        			}
        			...
        			if(unlocked.size() > 0){
	        			player.addChatMessage(new TextComponentString("Unlocked Recipes:"));
        			...
        			if(progressed.size() > 0){
	        			player.addChatMessage(new TextComponentString("Progressed Recipes:"));
        		...
        		default:
        			player.addChatMessage(new TextComponentString("Unknown mode! Available: lock, unlock, progress, list"));
        			break;
        	}
        }
    } 
