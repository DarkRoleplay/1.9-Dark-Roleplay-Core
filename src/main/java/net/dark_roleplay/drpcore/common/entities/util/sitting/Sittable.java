package net.dark_roleplay.drpcore.common.entities.util.sitting;
...
public class Sittable extends Entity{
	...
	public Sittable(World world, double x, double y, double z, double y0ffset, int rotation, double rotationOffset){
		this(world);
		this.blockPosX = (int) x;
		this.blockPosY = (int) y;
		this.blockPosZ = (int) z;
		setPositionConsideringRotation(x + 0.5D, y + y0ffset, z + 0.5D, rotation, rotationOffset);
	}
