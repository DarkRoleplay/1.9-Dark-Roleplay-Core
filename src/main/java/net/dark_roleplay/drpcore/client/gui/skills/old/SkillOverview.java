...
//		skillTreePanel = new DRPPanel(5, 5, 50, 50);
...
//		}
	...
	protected void drawMiddleground(int mouseX, int mouseY, float partialTicks) {
        ...
        GlStateManager.translate((float)(framePosX), (float)(framePosY), -400.0F);
        GlStateManager.enableDepth();
        

		GlStateManager.depthFunc(518);
	    drawRect(1, 1, gridWidth - 1, gridHeight - 1, -16777216);
...
//			}		
		...
		this.skillTreePanel.draw(mouseX, mouseY, partialTicks);
	}
