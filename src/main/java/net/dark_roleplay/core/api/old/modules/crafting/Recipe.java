...
public class Recipe extends IGuiElement.IMPL{
	...
	public void draw(int mouseX, int mouseY, float partialTicks) {
		...
		Gui.drawScaledCustomSizeModalRect(this.posX, this.posY, 8, 6, 28, 28, 28, 28, 64, 64);
		RenderItem itemRenderer = Minecraft.getMinecraft().getRenderItem();
		if(this.isHovered(mouseX, mouseY)){
			this.drawGradientRect(this.posX + 1, this.posY + 1, this.posX + 27, this.posY + 27, 0x66FFFFFF, 0x66FFFFFF);
			Gui.drawScaledCustomSizeModalRect(this.posX + 16, this.posY + 1, hoversOverStar(mouseX, mouseY) ? 47 : 36, 6, 11, 11, 11, 11, 64, 64);
