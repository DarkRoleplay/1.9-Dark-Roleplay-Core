...
//		this.addComponents();
		...
		this.elements.add(this.panelCraft = new Panel_Craft(this, this.width - 174, 10, 164, this.height - 20));
		this.elements.add(new Panel_Recipes(this, 10, 50, this.recipeAreaWidth, this.height - 60));
	...
	protected void drawBackground(int mouseX, int mouseY, float partialTicks) {
		...
		//Horiziontal Spacer
		this.drawTiled(9, 48, this.recipeAreaWidth + 1, 2, 6, 56, 50, 2, 64, 64);
		//Vertical Spacer
		this.drawTiled(this.recipeAreaWidth + 10, 9, 2, this.height - 18, 6, 6, 2, 50, 64, 64);
